    ...
    tz: {
        namron_thermostat_edge: {
            ...
            convertSet: async(entity, key, value, meta) => {
                ...
                else if (key === 'vacation_start_date') {               // 0 x8020  Vacation_start_date            INT32U  0x00 
...
const definitions = [
    {
        ...
        extend: [
            ...
            ////}),
//
            //// **** "holiday temp set" and "holiday_temp_set_f" are mapped in fz.Local 
            //////(0, modernExtend_1.numeric)({       // 0x8013  Holiday_temp_set                INT16S  0xBB8
            ...
            //////    scale: 100, 
            //////    cluster: 'hvacThermostat',
            //////    attribute: { ID: 0x8013, type: zigbee_herdsman_1.Zcl.DataType.INT16 } ,
            //////    description: 'Setpoint for Holiday mode',
            //////    access: 'STATE_GET',
            //////    entityCategory: 'diagnostic',
            //////}),
            //////(0, modernExtend_1.numeric)({     // 0x801B  Holiday_temp_set_f              INT16S  0x1388 
            //////    name: 'holiday_temp_set_f',
            //////    cluster: 'hvacThermostat',
            //////    attribute: { ID: 0x801b, type: zigbee_herdsman_1.Zcl.DataType.INT16 },
            //////    description: '',
            //////    entityCategory: 'config',
            //////}),
//
//
            //(0, modernExtend_1.numeric)({       // 0x801C  Regulation_mode                 ENUM8   0x00 // No data recieved
            ...
            //    entityCategory: 'diagnostic',
            //}),
            //(0, modernExtend_1.numeric)({       // 0x801D  Regulator_percentage            INT16S  0x00
            ...
            //}),
            //(0, modernExtend_1.binary)({        // 0x801F  Vacation_mode                   BOOLEAN false
            //    name: 'vacation_mode',
            //    valueOn: ['ON', 1],
            //    valueOff: ['OFF', 0],
            //    cluster: 'hvacThermostat',
            //    attribute: { ID: 0x801f, type: zigbee_herdsman_1.Zcl.DataType.BOOLEAN },
            //    description: 'Enable or Disable Vacation mode',
            //}),
//
            //// **** "vacation_start_date" and "vacation_end_date are mapped in fz.Local 
//
            ////(0, modernExtend_1.numeric)({       // 0x8020  Vacation_start_date             INT32U  0x00
            ////    name: 'vacation_start_date',
            ////    unit: 'date',
            ////    cluster: 'hvacThermostat',
            ////    attribute: { ID: 0x8020, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
            ////    description: '',
            ////    entityCategory: 'config',
            ////}),
            ////(0, modernExtend_1.numeric)({       // 0x8021  Vacation_end_date               INT32U  0x00
            ////    name: 'vacation_end_date',
            ////    unit: 'date',
            ////    cluster: 'hvacThermostat',
            ////    attribute: { ID: 0x8021, type: zigbee_herdsman_1.Zcl.DataType.UINT32 },
            ////    description: '',
            ////    entityCategory: 'config',
            ////}),
//
            //
            //(0, modernExtend_1.binary)({        // 0x8022  Auto_time                       BOOLEAN false
            //    name: 'auto_time',
            //    valueOn: ['ON', 1],
            //    valueOff: ['OFF', 0],
            //    cluster: 'hvacThermostat',
            ...
            //}),
            //(0, modernExtend_1.enumLookup)({    // 0x8023  Countdown_set                   ENUM8   0x00
            //    name: 'boost_mode',
            //    lookup: {'Off': 0, 'On': 1}, 
            //    cluster: 'hvacThermostat',
            //    attribute: { ID: 0x8023, type: zigbee_herdsman_1.Zcl.DataType.INT32 },
            //    description: 'Status of Boost Mode',
            //    access: 'STATE_GET',
            //    entityCategory: 'diagnostic',
            //}),
            //(0, modernExtend_1.numeric)({       // 0x8024  Countdown_left                  INT16S  0x00
            //    name: 'countdown_left',
            //    unit: 'minutes',
            //    valueMin: 0,
            //    valueMax: 120,
...
//
            ...
            e.binary('vacation_mode', ea.ALL, 'ON', 'OFF')
                .withDescription('Displays a "Palmtree" in display when on. If date is in future the "Palmtree is dimmed.'),
